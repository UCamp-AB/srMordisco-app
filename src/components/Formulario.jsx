    ...
    return (
        <>
            ...
            <form onSubmit={guardarReservacion}>
                <div className="mb-3">
                    <label className="form-label text-bold">Nombre de quien reserva</label>
                ...
                <div className="mb-3">
                    <label className="form-label text-bold">Cuantas personas?</label>
                    <input type="number" className="form-control" name='cuantos' value={formulario.cuantos} onChange={handleInputChange} />
                </div>
                <div className="mb-3">
                    <label className="form-label text-bold">Fecha de Reserva</label>
